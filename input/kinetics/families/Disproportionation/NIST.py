...
""",
    ...
    reference = Article(
        ...
        pages = """471""",
        year = "1987",
        url = "http://kinetics.nist.gov/kinetics/Detail?id=1987TSA471:40",
    ),
    referenceType = "review",
    shortDesc = u"""Extensive literature review""",
    longDesc = 
...
M. Harper, 8/30/09: No data available at the time. Author suggests a disproportionation rate coefficient near the collision limit, due to rxn's exothermicity. (p. 503, Entry 39,19a)
""",
    history = [
        ("Tue Sep  4 15:00:26 2012","Sean Troiano <stroiano7@gmail.com>","action","""Imported from NIST database at http://kinetics.nist.gov/kinetics/Detail?id=1987TSA471:40"""),
    ],
)
...
""",
    ...
    reference = Article(
        ...
        pages = """471""",
        year = "1987",
        url = "http://kinetics.nist.gov/kinetics/Detail?id=1987TSA471:28",
    ),
    referenceType = "review",
    shortDesc = u"""Extensive literature review""",
    longDesc = 
...
M. Harper, 8/30/09: No data available at the time. Author suggest a disproportionation rate coefficient of 6.0E-11 cm3/molecule/s, due to very exothermic rxn. (p. 504, Entry 39,21a)
""",
    history = [
        ("Tue Sep  4 15:04:36 2012","Sean Troiano <stroiano7@gmail.com>","action","""Imported from NIST database at http://kinetics.nist.gov/kinetics/Detail?id=1987TSA471:28"""),
    ],
)
...
""",
    ...
    reference = Article(
        ...
        pages = """471""",
        year = "1987",
        url = "http://kinetics.nist.gov/kinetics/Detail?id=1987TSA471:38",
    ),
    referenceType = "review",
    shortDesc = u"""Extensive literature review""",
    longDesc = 
...
M. Harper, 8/30/09: No data available at the time. Author estimates a disproportionation rate coefficient of 3E-11 cm3/molecule/s. (p. 500, Entry 39,15b)
""",
    history = [
        ("Tue Sep  4 15:12:12 2012","Sean Troiano <stroiano7@gmail.com>","action","""Imported from NIST database at http://kinetics.nist.gov/kinetics/Detail?id=1987TSA471:38"""),
    ],
)
...
""",
    ...
    reference = Article(
        ...
        pages = """471""",
        year = "1987",
        url = "http://kinetics.nist.gov/kinetics/Detail?id=1987TSA471:44",
    ),
    referenceType = "review",
    shortDesc = u"""Extensive literature review""",
    longDesc = 
...
M. Harper, 8/30/09: No data available at the time. Author estimates a disproportionation rate coefficient of 4E-11 cm3/molecule/s. (p. 497, Entry 39,6)
""",
    history = [
        ("Tue Sep  4 15:18:24 2012","Sean Troiano <stroiano7@gmail.com>","action","""Imported from NIST database at http://kinetics.nist.gov/kinetics/Detail?id=1987TSA471:44"""),
    ],
)
...
""",
    ...
    reference = Article(
        ...
        pages = """471""",
        year = "1987",
        url = "http://kinetics.nist.gov/kinetics/Detail?id=1987TSA471:43",
    ),
    referenceType = "review",
    shortDesc = u"""Extensive literature review""",
    longDesc = 
...
M. Harper, 8/30/09: No data available at the time. Author recommends a disproportionation rate coefficient of 2E-11 cm3/molecules/s. (p. 498, Entry 39,7)
""",
    history = [
        ("Tue Sep  4 15:27:35 2012","Sean Troiano <stroiano7@gmail.com>","action","""Imported from NIST database at http://kinetics.nist.gov/kinetics/Detail?id=1987TSA471:43"""),
    ],
)
